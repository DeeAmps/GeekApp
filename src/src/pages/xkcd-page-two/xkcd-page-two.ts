...
/**
 * Generated class for the XkcdPageTwoPage page.
 *
...
@IonicPage()
@Component({
  selector: 'page-xkcd-page-two',
  templateUrl: 'xkcd-page-two.html',
})
export class XkcdPageTwoPage {
  comics:any;
  ...
  initialize(){
    ...
    loading.present();
    this.comicApi.getXKCDOpenComicsPagesTwo().subscribe(data => {
      this.comics = data;
      loading.dismiss();
    },
    error => {
