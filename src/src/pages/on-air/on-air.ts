...
/**
 * Generated class for the OnAirPage page.
 *
...
@IonicPage()
@Component({
  selector: 'page-on-air',
  templateUrl: 'on-air.html',
})
export class OnAirPage {
  Airing:any;
  ...
  ionViewDidLoad() {
    ...
    let loading = this.loadCtrl.create({
      content: 'Retrieving Running Series..'
    });
    loading.present();
    this.tvApi.EpisodeInNext7days().subscribe(
      data => {
        this.Airing = data;
        loading.dismiss();
