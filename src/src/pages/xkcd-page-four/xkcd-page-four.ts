...
/**
 * Generated class for the XkcdPageFourPage page.
 *
...
@IonicPage()
@Component({
  selector: 'page-xkcd-page-four',
  templateUrl: 'xkcd-page-four.html',
})
export class XkcdPageFourPage {
  comics:any;
  ...
  initialize(){
    ...
    loading.present();
    this.comicApi.getXKCDOpenComicsPagesFour().subscribe(data => {
      this.comics = data;
      loading.dismiss();
    },error => {
      loading.dismiss();
